...
int main(){
    ...
    //add text
    fsprHallo.addText(0,0,480,100,"Press to set Color:");
    fsprHallo.addText(0,50,320,100,"1: Red");
    fsprHallo.addText(0,100,320,100,"2: Green");
    fsprHallo.addText(0,150,320,100,"3: Blue");
    fsprHallo.addText(0,200,320,100,"4: Yellow");
    fsprHallo.addText(0,250,320,100,"5: Violet");
    fsprHallo.addText(0,300,320,100,"6: White");
