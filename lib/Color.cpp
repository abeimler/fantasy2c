...
const Color& Color::operator += (const Color& color){
    this->red = clamp(static_cast<int>(this->red)+color.red,0,255);
    this->green = clamp(static_cast<int>(this->green)+color.green,0,255);
    this->blue = clamp(static_cast<int>(this->blue)+color.blue,0,255);
    this->alpha = clamp(static_cast<int>(this->alpha)+color.alpha,0,255);
...
const Color& Color::operator *= (float col){
    this->red = clamp<int>(this->red*col,0,255);
    this->green = clamp<int>(this->green*col,0,255);
    this->blue = clamp<int>(this->blue*col,0,255);
    this->alpha = clamp<int>(this->alpha*col,0,255);
