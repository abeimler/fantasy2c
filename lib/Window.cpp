...
void Timer::reset(){this->starttime = glfwGetTime();}
double Timer::getTime(){return glfwGetTime()-this->starttime;}
double Timer::getTimeMilisec(){ return (glfwGetTime()-this->starttime)*1000.0f;}
