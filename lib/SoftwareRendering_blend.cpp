...
void SoftwareRendering::blendFuncPixel(GLenum mode, //Blend Mode (GL_ONE,GL_ZERO,GL_SRC_COLOR,GL_DST_COLOR,...)
                                    ...
                                    GLubyte* srcPixels, //pixels of Src (must RGBA format)
                                    GLubyte* dstPixels, //pixels of Dst (must RGBA format)
...
void SoftwareRendering::blendFuncPixel(GLenum mode, //Blend Mode (GL_ONE,GL_ZERO,GL_SRC_COLOR,GL_DST_COLOR,...)
                                    ...
                                    GLint* srcPixels, //pixels of Src (must RGBA format)
                                    GLint* dstPixels, //pixels of Dst (must RGBA format)
                                    const Color4f& cBlendColor)
{
    if(mode == GL_ONE)
        return;
                                    ...
                                    const Color4f& cBlendColor)
{
    ...
    ubyte constBlendColor[4] = { cBlendColor.r,cBlendColor.g,cBlendColor.b,cBlendColor.a };
