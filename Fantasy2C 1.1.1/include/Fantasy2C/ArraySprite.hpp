...
template class DLL std::allocator< SpriteElement >;
template class DLL std::vector< SpriteElement, std::allocator<SpriteElement> >;
#endif
...
class DLL ArraySprite{
	...
	public:
        ...
        */
		int render(size_t starteid) const;
		/**
        ...
        */
		int render(size_t starteid,size_t endeid) const;
