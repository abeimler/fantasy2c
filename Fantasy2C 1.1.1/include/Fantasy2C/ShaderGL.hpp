...
class DLL ShaderGL{
    ...
    */
    int LoadGLFragmentShader(std::string shaderfilename,std::string* error = NULL);
    /**
    *@return -1, Can't open the Shaderfile.
    *@return -2, The Shaderfile is empty.
    *@param shaderfilename Filename
    ...
    */
    int LoadGLVertexShader(std::string shaderfilename,std::string* error = NULL);
